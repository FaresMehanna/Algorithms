 ...
 * ---------------
 * Defines the interface for the insertionsort.
 *
 * Given an generic array this function will sort the given array using Insertion sort
 */
 ...
 */
void Insertionsort(void* array, int elemsize, int len, CompareFunction);
